...
function TodoApp() {
    const seedTodos = [
        {id: uuid(), task: "Buy bread", completed: false, isEditable: true},
        {id: uuid(), task: "Fix car key", completed: true, isEditable: false},
        {id: uuid(), task: "Meditate", completed: false, isEditable: false},
    ]
